...
- `chrome-web-store-listing.md` is a generated, copy-ready dashboard dossier. Edit `extension.config.json`, then run `pnpm extension store-dossier window-resizer`; do not edit the dossier directly.
